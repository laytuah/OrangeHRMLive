...
namespace OrangeHRMLive.PageObjects
{
    public class BasePage
    {
        ...
        protected PageElement Select_dropdown(string selectText) => new PageElement(Driver, By.XPath($"//div[contains(@class,'oxd-select-dropdown')]//span[contains(normalize-space(translate(., 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')),\"{selectText}\")]"));
